...
assert.ok(template.rows.length >= 10000 && template.rows.length <= 12000, "template should contain 10,000-12,000 legitimate reference rows");
...
assert.ok(metadata.actual_records >= 10000 && metadata.actual_records <= 12000);
